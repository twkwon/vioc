...
typedef	struct {
	...
	reg_t				AD			: 2;
	reg_t							:16;
}	VIOC_POWER_BLOCKS_ADFB;

typedef	union {
	reg_t					nREG;
	VIOC_POWER_BLOCKS_ADFB	bREG;
}	VIOC_POWER_BLOCKS_ADFB_u;
...
typedef	struct	_VIOC_IREQ_CONFIG
{
	...
	volatile VIOC_CONFIG_PATH_MC_u		uPATH_MC;			// 0x3C
	...
	volatile VIOC_POWER_BLOCKS_u 		uPOWERDOWN;			// 0xD0, 0xD4	(PWDN0/1 and SWR0/1 is a pair)
	volatile VIOC_POWER_BLOCKS_u 		uSOFTRESET;			// 0xD8, 0xDC	(PWDN0/1 and SWR0/1 is a pair)

	reg_t 								reserved6[2];		// 0xE0, 0xE4

	volatile VIOC_POWER_BLOCKS_ADFB_u	uSOFTRESET2;		// 0xE8		(SWR2 is AFBC DEC reset)

	reg_t 								reserved7[3];		// 0xEC, 0xF0, 0xF4
	...
	volatile VIOC_POWER_BLOCKS_SC_u		uPOWERDOWN2;		// 0x128		(PWDN2 is Scaler)
	...
	volatile VIOC_CONFIG_PATH_u 		uSC6;				// 0x1A8
	volatile VIOC_CONFIG_PATH_u 		uSC7;				// 0x1AC
